...
public class AntiCheatHelp implements Subcommand , HelpCommand
{

	private String description = "Show anticheat command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.anticheat.help";
	private boolean playeronly = true;
	private String usage = "/anticheat help";

	public AntiCheatHelp( MainCommand maincommand )
	{
	...
	public void run( CommandSender sender, String[] args )
	{
		...
		if (args.length > 1)
		{
			...
			if (CommandHelper.isPositiveInt(args[1]))
			{
				...
				CommandHelper.sendHelp(sender, entries, "Anticheat", CommandHelper.getInt(args[1]));
